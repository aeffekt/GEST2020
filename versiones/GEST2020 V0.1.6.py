...
def help_info():
    ...
    help_window.iconbitmap('LOGOLIE x3.ico')
    ...
    help_tree.insert(help_one, tk.END, text='Primero debe importar las bases de datos con Excel: '
                                            '"MAESTRO.dbf", "LISTAS.dbf", "OT.dbf" del programa GEST DOS original')
    help_tree.insert(help_one, tk.END, text='Ir a menú "archivo/convertir planillas" y guardarlas en formato XLS.')
    help_tree.insert(help_one, tk.END, text='Al reiniciar el programa, automáticamente se cargará el Maestro de artículos')
